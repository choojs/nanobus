...
declare class Nanobus<E extends Events = Events> {
    ...
    protected _starListeners: Listener[]
    ...
    protected _emit<K extends keyof E | symbol>(array: NanobusListener<E, K>[], eventName: K, data: Parameters<NanobusListener<E, K>>, performanceTimingId?: string): void
    ...
    removeListener<K extends keyof E | "*" | symbol>(eventName: K, listener: NanobusListener<E, K>): true | undefined
    removeAllListeners(eventName?: keyof E | "*" | symbol): this
    listeners<K extends keyof E | "*" | symbol>(eventName: K): NanobusListener<E, K>[]
}
